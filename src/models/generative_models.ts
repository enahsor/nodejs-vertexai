...
export class GenerativeModel {
   ...
   * console.log('Response: ', JSON.stringify(await resp.response));
   * ```
   *
   ...
   * const resp1 = await chat.sendMessage("How can I learn more about Node.js?");
   * console.log('Response: ', JSON.stringify(await resp1.response));
   *
